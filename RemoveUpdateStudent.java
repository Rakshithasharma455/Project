 ...
 * @author USER
 */
public class RemoveUpdateStudent extends javax.swing.JFrame {

    /**
     * Creates new form RemoveUpdateStudent
     */
    public RemoveUpdateStudent() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Remove and Update Student");
        ...
        jTextField11.setFont(new java.awt.Font("Arial Unicode MS", 0, 12)); // NOI18N

        jTextField12.setFont(new java.awt.Font("Arial Unicode MS", 0, 12)); // NOI18N

        jTextField13.setFont(new java.awt.Font("Arial Unicode MS", 0, 12)); // NOI18N

        jLabel15.setFont(new java.awt.Font("Arial Unicode MS", 1, 14)); // NOI18N
        jLabel15.setText("Amount");

        jTextField14.setFont(new java.awt.Font("Arial Unicode MS", 0, 12)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextField14, javax.swing.GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String School =jTextField11.getText();
        String Address =jTextField13.getText();
        String Amount =jTextField14.getText();
        try
        {
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update newstudent set FullName=?,MotherName=?,FatherName=?,DateOfBirth=?,MobileNo=?,Email=?,Year=?,SchoolName=?,Address=?,Amount=? where id=?");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(a==0)
        {
            ...
            try
            {
                Connection con = ConnectionProvider.getCon();
                Statement st = con.createStatement();
                st.executeUpdate("delete from newstudent where ID='"+ID+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveUpdateStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
